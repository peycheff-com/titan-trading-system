...
> **Context**: Service > AI Research (Quant)
...
- **AI-Powered Analysis**: Uses Gemini 2.0 Flash for cost-effective pattern recognition
...
Uses Gemini 2.0 Flash to analyze patterns and generate optimization proposals.
