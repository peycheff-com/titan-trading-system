...
class OrderedConsumer {
    ...
    public processedEvents: number[] = [];
    public buffer: Map<number, any> = new Map();

    async handleEvent(event: { seq: number; data: string }) {
        // If exact match
    ...
    private process(event: { seq: number; data: string }) {
