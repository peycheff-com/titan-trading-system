...
async function main() {
    ...
    if (passed) {
        console.log(`✅ PASSED: P99 latency (${stats.totalLatency.p99.toFixed(3)}ms) < ${targetP99}ms target`);
    }
    else {
        console.log(`❌ FAILED: P99 latency (${stats.totalLatency.p99.toFixed(3)}ms) > ${targetP99}ms target`);
    }
    // Cleanup
...
//# sourceMappingURL=e2e-latency-test.js.map