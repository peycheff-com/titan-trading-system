...
-- Insert default operator (password: admin123)
INSERT INTO operators (operator_id, hashed_password, permissions) 
VALUES ('admin', '$2b$10$rOzJqQZQZQZQZQZQZQZQZOzJqQZQZQZQZQZQZQZQZOzJqQZQZQZQZQ', '["admin", "override", "treasury"]')
ON CONFLICT (operator_id) DO NOTHING;

-- Initialize high watermark
INSERT INTO high_watermark (value, updated_at) 
VALUES (1000.00, EXTRACT(epoch FROM NOW()) * 1000)
