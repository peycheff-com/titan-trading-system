...
} from "../../src/risk/PortfolioManager";
import { HologramState, Position, SignalData } from "../../src/types";
...
describe("PortfolioManager", () => {
  ...
  describe("calcTotalExposure", () => {
    it("should calculate total exposure correctly", () => {
      ...
      const exposure = portfolioManager.calcTotalExposure(
        mockPositions,
        totalEquity,
      );
  ...
  describe("allocateRiskPerTrade", () => {
    it("should allocate risk dynamically based on open positions", () => {
      const totalEquity = 10000;
      const allocation = portfolioManager.allocateRiskPerTrade(
        totalEquity,
        mockPositions,
      );
  ...
  describe("checkPortfolioHeat", () => {
    it("should calculate portfolio heat correctly", () => {
      const totalEquity = 10000;
      const canTrade = portfolioManager.checkPortfolioHeat(
        mockPositions,
        totalEquity,
      );
