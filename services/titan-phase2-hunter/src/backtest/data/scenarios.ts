...
export const SCENARIOS: Record<string, TestScenario> = {
  ...
  BULL_ORACLE_SUPPORT: {
    ...
    description: 'Price is trending up, and Oracle sentiment is consistently bullish.',
  ...
  MANIPULATION_VETO: {
    ...
    description: 'Price moves up but Global CVD diverges significantly (manipulation).',
