...
export class PositionManager extends EventEmitter {
  ...
  public removePosition(positionId: string): void {
    ...
    if (position) {
      ...
      console.log(`📊 Position Manager: Removed position ${positionId}`);
    }
  }
  ...
  public async moveStopToBreakeven(position: Position): Promise<boolean> {
    try {
      ...
      console.error(`❌ Failed to move stop to breakeven for ${position.symbol}:`, error);
  ...
  public async takePartialProfit(position: Position): Promise<boolean> {
    try {
      ...
      console.error(`❌ Failed to take partial profit for ${position.symbol}:`, error);
      this.emit('position:error', position, error as Error);
      return false;
    }
  }
  ...
  public async updateTrailingStop(position: Position): Promise<boolean> {
    try {
      ...
      console.error(`❌ Failed to update trailing stop for ${position.symbol}:`, error);
      this.emit('position:error', position, error as Error);
      return false;
    }
  }
  ...
  private startMonitoring(): void {
    ...
    console.log(`📊 Position Manager: Started monitoring (${this.UPDATE_FREQUENCY}ms interval)`);
  }
  ...
  public stopMonitoring(): void {
    ...
    console.log(`📊 Position Manager: Stopped monitoring`);
  }
  ...
  public updateConfig(newConfig: Partial<PositionManagerConfig>): void {
    ...
    console.log(`📊 Position Manager: Configuration updated`);
  }
  ...
  public async emergencyCloseAll(): Promise<{ success: number; failed: number }> {
    ...
    console.log(`🚨 Emergency close complete: ${success} success, ${failed} failed`);
  ...
  public destroy(): void {
    ...
    console.log(`📊 Position Manager: Destroyed`);
  }
}
