...
async function main() {
    ...
    console.log("Config loaded:", JSON.stringify(config.brain?.activeInference, null, 2));
    ...
    if (metrics.historySize < 50) {
        throw new Error(`Expected at least 50 history points, got ${metrics.historySize}`);
    }
    ...
    console.log("Final Inference State:", JSON.stringify({
...
//# sourceMappingURL=verify_ai_integration.js.map