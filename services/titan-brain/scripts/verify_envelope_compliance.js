import { getNatsPublisher, } from "../src/server/NatsPublisher.js";
...
async function verify() {
    ...
    // Subscribe to verify
    const sub = nats.subscribe(TitanSubject.AI_OPTIMIZATION_REQUESTS, (data, subject) => {
        console.log(`Received message on ${subject}:`, JSON.stringify(data, null, 2));
        try {
...
//# sourceMappingURL=verify_envelope_compliance.js.map