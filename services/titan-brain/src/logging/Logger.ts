...
import { Logger as SharedLogger, SharedLogLevel } from '@titan/shared';
import type { LoggerConfig, PerformanceTimer, SharedLogEntry as LogEntry } from '@titan/shared';

// Re-export types
export type { LogEntry, LoggerConfig, PerformanceTimer };
