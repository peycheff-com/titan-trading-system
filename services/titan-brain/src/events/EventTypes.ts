...
export const EventType = {
  ...
  RISK_CONFIG_UPDATE: 'RISK_CONFIG_UPDATE',
  RESET: 'RESET', // Legacy/Simple
  // Identity & Authority events
  OPERATOR_LOGIN: 'OPERATOR_LOGIN',
  OPERATOR_LOGOUT: 'OPERATOR_LOGOUT',
  SAFETY_SESSION_ARMED: 'SAFETY_SESSION_ARMED',
  SAFETY_SESSION_DISARMED: 'SAFETY_SESSION_DISARMED',
  INTENT_APPROVED: 'INTENT_APPROVED',
  INTENT_APPROVAL_REJECTED: 'INTENT_APPROVAL_REJECTED',
} as const;
