...
export class DashboardController {
  ...
  registerRoutes(server: FastifyInstance): void {
    ...
    server.get('/dashboard/extended', this.handleExtendedDashboard.bind(this));
    server.get('/dashboard/export', this.handleDashboardExport.bind(this));
    server.get('/dashboard/export/extended', this.handleExtendedDashboardExport.bind(this));
    server.get('/phases/approval-rates', this.handleApprovalRates.bind(this));
   ...
   */
  async handleDashboard(_request: FastifyRequest, reply: FastifyReply): Promise<void> {
    try {
   ...
   */
  async handleExtendedDashboard(_request: FastifyRequest, reply: FastifyReply): Promise<void> {
    try {
   ...
   */
  async handleDashboardExport(_request: FastifyRequest, reply: FastifyReply): Promise<void> {
    try {
   ...
   */
  async handleApprovalRates(_request: FastifyRequest, reply: FastifyReply): Promise<void> {
    try {
   ...
   */
  async handleTreasuryStatus(_request: FastifyRequest, reply: FastifyReply): Promise<void> {
    try {
   ...
   */
  async handleAllocation(_request: FastifyRequest, reply: FastifyReply): Promise<void> {
    try {
   ...
   */
  async handleBreakerStatus(_request: FastifyRequest, reply: FastifyReply): Promise<void> {
    try {
   ...
   */
  async handlePhasesStatus(_request: FastifyRequest, reply: FastifyReply): Promise<void> {
    try {
   ...
   */
  async handlePhaseRegister(request: FastifyRequest, reply: FastifyReply): Promise<void> {
