...
import { DefconLevel, GovernanceEngine, SystemHealth } from '../engine/GovernanceEngine.js';
...
async function testCanaryLogic() {
  ...
  // @ts-ignore - TS flow analysis doesn't track side effects of updateHealth callback
