import { PostingEngine } from "../../../src/services/accounting/PostingEngine.js";
import { FillReport } from "@titan/shared";
import { LedgerDirection, LedgerEventType } from "../../../src/types/ledger.js";
...
describe("PostingEngine", () => {
    const mockFill: FillReport = {
        ...
        signal_id: "sig-123",
        client_order_id: "cl-123", // Added required field
        symbol: "BTC/USDT",
        // venue: "binance", // Removed
        // account: "spot", // Removed
        side: "BUY",
        price: 50000,
        qty: 1.0,
        fee: 5.0,
