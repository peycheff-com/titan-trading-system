...
import {
  ...
  HMACDefaults,
  HMACValidator,
} from "../../src/security/HMACValidator";
...
describe("HMACValidator", () => {
  ...
  describe("constructor", () => {
    ...
    it("should throw error if secret is missing", () => {
      expect(() => new HMACValidator({ secret: "" })).toThrow(
  ...
  describe("fromEnvironment", () => {
    ...
    it("should use fallback secret in test environment if HMAC_SECRET is missing", () => {
      delete process.env.HMAC_SECRET;

      // In test env (NODE_ENV=test), it should NOT throw but use fallback secret
      const envValidator = HMACValidator.fromEnvironment();
  ...
  describe("utility methods", () => {
    ...
    it("should throw error when updating to empty secret", () => {
      expect(() => validator.updateSecret("")).toThrow(
