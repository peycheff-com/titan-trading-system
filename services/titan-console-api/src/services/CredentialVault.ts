...
export type CredentialProvider = 'bybit' | 'binance' | 'deribit' | 'hyperliquid' | 'gemini';

export type CredentialType = 'api_key' | 'api_secret' | 'oauth_token' | 'oauth_refresh_token';
...
class CredentialVault {
  ...
  decrypt(encryptedData: EncryptedData): string {
    ...
    const decrypted =
      decipher.update(encryptedData.encryptedValue, 'hex', 'utf8') + decipher.final('utf8');
