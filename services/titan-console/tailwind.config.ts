  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        titan: {
          glow: "hsl(var(--titan-glow))",
          surface: "hsl(var(--titan-surface))",
          "surface-elevated": "hsl(var(--titan-surface-elevated))",
        },
        status: {
        ...
        phase: {
          scavenger: "hsl(var(--phase-scavenger))",
          hunter: "hsl(var(--phase-hunter))",
          sentinel: "hsl(var(--phase-sentinel))",
        },
        pnl: {
