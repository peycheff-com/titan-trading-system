...
export function TrapMapCanvas({ traps, height = 300 }: TrapMapCanvasProps) {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      traps.forEach((trap, index) => {
        ...
        if (trap.proximity < 0.01) color = '#ef4444'; // Red (Critical)
  ...
  return (
    <div ref={containerRef} className="w-full relative rounded-lg border border-border overflow-hidden bg-zinc-950">
