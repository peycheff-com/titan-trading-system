  ...
  return (
    <Card
      className={cn(
        ...
        isCrisis ? 'border-destructive/50 bg-destructive/5' : '',
      )}
    >
      ...
      <CardContent>
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="flex flex-col space-y-1">
            ...
            <Badge
              variant="outline"
              className={cn('w-fit uppercase text-[10px]', getVolColor(volatilityState))}
            >
              {volatilityState}
            </Badge>
            <span className="text-[10px] text-muted-foreground">Cycle Phase</span>
          </div>
          ...
          <div className="flex flex-col space-y-1">
            ...
            <span className="text-[10px] text-muted-foreground">Hurst ~ 0.72</span>
          </div>
        </div>
      </CardContent>
    </Card>
