...
export default function TradeControl() {
  ...
  const [positions, setPositions] = useState<Position[]>([
      { symbol: 'BTCUSDT', side: 'Buy', size: 0.5, entryPrice: 64200, markPrice: 64500, unrealizedPnl: 150, liquidationPrice: 58000, leverage: 10 },
      { symbol: 'ETHUSDT', side: 'Sell', size: 5.0, entryPrice: 3400, markPrice: 3420, unrealizedPnl: -100, liquidationPrice: 3600, leverage: 10 }
  ]);
    ...
    <div className="space-y-6 animate-fade-in p-2 md:p-0">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
             <Button variant="outline" className="w-full sm:w-auto border-orange-500 text-orange-500 hover:bg-orange-500/10 hover:text-orange-600 h-10">
                <PauseCircle className="mr-2 h-4 w-4" />
                Pause Trading
             </Button>
            <Button variant="destructive" className="w-full sm:w-auto h-10" onClick={() => setShowHaltModal(true)}>
