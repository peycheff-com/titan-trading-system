    ...
    <div className="space-y-6 animate-fade-in pb-12">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Manage global risk budgets, circuit breakers, and manual overrides.</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="border-orange-500/20 bg-orange-500/5">
          ...
          <CardFooter className="justify-between border-t border-orange-500/10 pt-4">
             <div className="text-xs text-muted-foreground">
               Action logged in immutable ledger.
             </div>
             <ActionDialog 
        ...
        <Card className="border-red-500/20 bg-red-500/5">
          <CardHeader>
            ...
            <CardDescription>
              Emergency controls for system-wide halts.
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="space-y-4">
               <ActionDialog 
                  trigger={<Button variant="destructive" className="w-full">EMERGENCY HALT</Button>}
                  ...
                  onConfirm={async (reason) => {
                    try {
                        const res = await fetch(`${getApiBaseUrl()}/risk/halt`, {
                            ...
                            body: JSON.stringify({ operatorId, reason: reason || 'Manual Emergency Halt' })
                        });
               ...
               <ActionDialog 
                  trigger={<Button variant="outline" className="w-full">Reset Breaker</Button>}
