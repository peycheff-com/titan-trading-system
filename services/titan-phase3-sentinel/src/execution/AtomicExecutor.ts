...
export class AtomicExecutor {
  ...
  constructor(executor: IOrderExecutor, config: AtomicConfig = DEFAULT_ATOMIC_CONFIG) {
  ...
  private async handleRevert(result: ExecutionResult, leg1: Order, leg2: Order): Promise<void> {
