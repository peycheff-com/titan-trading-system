import { z } from "zod";
import {
    emergencyActionPayloadSchema,
    modelPromotionPayloadSchema,
    paramUpdatePayloadSchema,
...
export type EmergencyActionPayload = z.infer<
    typeof emergencyActionPayloadSchema
>;
