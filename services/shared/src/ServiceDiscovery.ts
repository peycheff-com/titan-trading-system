...
class ServiceRegistry extends EventEmitter {
   ...
   */
  private generateServiceId(service: Omit<ServiceInstance, 'id' | 'registeredAt' | 'lastHeartbeat' | 'status'>): string {
...
export class ServiceDiscovery extends EventEmitter {
   ...
   */
  getServiceEndpoint(serviceName: string, endpoint: 'api' | 'websocket' | 'health' | 'metrics' = 'api'): string | null {
