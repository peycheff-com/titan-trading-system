 ...
 * Environment types
 */
exports.EnvironmentSchema = zod_1.z.enum(['development', 'staging', 'production']);
/**
...
exports.PhaseConfigSchema = zod_1.z.object({
    ...
    environments: zod_1.z.record(zod_1.z.string(), zod_1.z.object({
        ...
        exchanges: zod_1.z.record(zod_1.z.string(), exports.ExchangeConfigSchema.partial()).optional(),
        parameters: zod_1.z.record(zod_1.z.string(), zod_1.z.unknown()).optional()
    }).partial()).optional()
});
/**
...
exports.ServiceConfigSchemas = {
    ...
    'titan-console': zod_1.z.object({
        ...
        session: zod_1.z.object({
            ...
            maxAge: zod_1.z.number().min(3600000) // 1 hour minimum
        })
    })
};
/**
