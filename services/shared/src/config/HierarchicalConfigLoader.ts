    ...
    for (const [key, value] of Object.entries(override)) {
      if (value !== undefined && value !== null) {
        if (typeof value === 'object' && !Array.isArray(value) && 
            typeof (result as any)[key] === 'object' && !Array.isArray((result as any)[key])) {
          // Deep merge objects
 ...
 */
export function createConfigLoader(options?: Partial<ConfigHierarchyOptions>): HierarchicalConfigLoader {
