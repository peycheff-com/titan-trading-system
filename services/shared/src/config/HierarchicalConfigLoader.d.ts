 ...
 */
import { Environment, BrainConfig, PhaseConfig, InfrastructureConfig, DeploymentConfig, ValidationResult } from './ConfigSchema';
/**
...
export declare class HierarchicalConfigLoader {
     ...
     */
    loadServiceConfig(service: string): Promise<ConfigLoadResult<any>>;
    /**
