...
import {
  MarketRegime,
  PredictiveAnalytics,
} from "../../src/ai/PredictiveAnalytics";
...
describe("PredictiveAnalytics", () => {
  ...
  describe("correlation analysis", () => {
    ...
    it("should calculate portfolio correlation", () => {
      ...
      expect(analysis.diversificationScore).toBe(
        1 - analysis.portfolioCorrelation,
      );
    });
  });
  ...
  describe("strategy performance prediction", () => {
    ...
    it("should predict strategy performance", () => {
      const prediction = analytics.predictStrategyPerformance(
        "oi_wipeout",
        "BTCUSDT",
      );
      ...
      expect(prediction!.predictedPerformance.winProbability)
  ...
  describe("risk adjustment generation", () => {
    ...
    it("should generate risk adjustments for regime changes", () => {
      ...
      expect(adjustments.length).toBeGreaterThan(0);
      const regimeAdjustment = adjustments.find((adj) =>
        adj.trigger === "regime_change"
      );
