...
import { TripwireCalculators, OHLCV, Tripwire } from '../../src/calculators/TripwireCalculators';
...
describe('TripwireCalculators', () => {
  ...
  describe('calcLiquidationCluster', () => {
    it('should return null for insufficient data', () => {
      const ohlcv: OHLCV[] = Array.from({ length: 30 }, (_, i) => ({
        timestamp: i * 1000,
        open: 100,
        high: 105,
        low: 95,
  ...
  describe('calcBollingerBreakout', () => {
    it('should return null for insufficient data', () => {
      const ohlcv: OHLCV[] = Array.from({ length: 50 }, (_, i) => ({
        timestamp: i * 1000,
        open: 100,
        high: 105,
        low: 95,
