...
export class BybitPerpsClient {
    ...
    async getFundingRate(symbol) {
        try {
            ...
            throw new Error(`Failed to get funding rate for ${symbol}: ${error instanceof Error ? error.message : "Unknown error"}`);
        }
    }
    /**
    ...
    async getOpenInterest(symbol) {
        try {
            ...
            throw new Error(`Failed to get open interest for ${symbol}: ${error instanceof Error ? error.message : "Unknown error"}`);
        }
    }
    /**
    ...
    async get24hVolume(symbol) {
        try {
            ...
            throw new Error(`Failed to get 24h volume for ${symbol}: ${error instanceof Error ? error.message : "Unknown error"}`);
        }
    }
}
//# sourceMappingURL=BybitPerpsClient.js.map