...
export class TripwireCalculators {
     ...
     */
    static calcLiquidationCluster(ohlcv, symbol = "") {
        if (ohlcv.length < 50) {
     ...
     */
    static buildVolumeProfile(ohlcv, bins) {
     ...
     */
    static calcDailyLevel(ohlcv, symbol = "") {
     ...
     */
    static calcBollingerBreakout(ohlcv, symbol = "") {
        const period = 20;
     ...
     */
    static calcADX(ohlcv, period = 14) {
        ...
        for (const val of recentDX)
            sumDX += val;
        return sumDX / recentDX.length;
    }
}
//# sourceMappingURL=TripwireCalculators.js.map