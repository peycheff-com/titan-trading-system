...
export class VelocityCalculator {
     ...
     */
    recordPrice(symbol, price, exchangeTime) {
        ...
        this.priceHistory.set(symbol, history.filter((h) => h.timestamp > cutoff));
    }
    /**
    ...
    calcVelocity(symbol) {
        ...
        const timeDiffSeconds = (recentPrices[recentPrices.length - 1].timestamp -
...
//# sourceMappingURL=VelocityCalculator.js.map