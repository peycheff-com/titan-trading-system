...
async function main() {
    ...
    console.log(`📁 Credentials will be stored at: ${credManager.getCredentialsPath()}\n`);
    ...
    try {
        credManager.updateExchangeCredentials("binance", "updated-binance-key", "updated-binance-secret");
        console.log("✅ Binance credentials updated\n");
    }
    catch (error) {
        console.error("❌ Failed to update credentials:", error instanceof Error ? error.message : "Unknown error");
    }
...
//# sourceMappingURL=credential-setup-example.js.map