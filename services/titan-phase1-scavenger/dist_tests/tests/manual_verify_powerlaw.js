...
async function run() {
    const protocol = new UltimateBulgariaProtocol(mockBybit, mockBinance, mockDetector);
...
//# sourceMappingURL=manual_verify_powerlaw.js.map