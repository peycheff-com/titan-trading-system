...
describe('BinanceSpotClient', () => {
    ...
    describe('message handling', () => {
        it('should parse aggTrade messages and trigger callbacks', async () => {
            ...
            if (messageHandler)
                messageHandler.call(mockWs, Buffer.from(JSON.stringify(aggTradeMsg)));
        ...
        it('should handle invalid JSON gracefully', async () => {
            ...
            // Send invalid JSON
            if (messageHandler)
                messageHandler.call(mockWs, Buffer.from('invalid json'));
        ...
        it('should only trigger callback for subscribed symbols', async () => {
            ...
            if (messageHandler)
                messageHandler.call(mockWs, Buffer.from(JSON.stringify(btcMsg)));
...
//# sourceMappingURL=BinanceSpotClient.test.js.map