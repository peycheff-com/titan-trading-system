 ...
 */
import { ConnectionState, FastPathClient } from "@titan/shared";
...
describe("FastPathClient", () => {
    ...
    beforeEach(() => {
        ...
        mockNet.connect.mockReturnValue(mockSocket);
    ...
    describe("Force Reconnection", () => {
        it("should force reconnection successfully", async () => {
            ...
            setTimeout(() => {
                ...
                mockNet.connect.mockReturnValue(newMockSocket);
...
//# sourceMappingURL=FastPathClient.test.js.map