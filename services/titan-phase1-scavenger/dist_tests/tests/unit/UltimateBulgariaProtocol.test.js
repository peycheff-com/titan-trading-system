 ...
 */
import { UltimateBulgariaProtocol } from '../../src/detectors/UltimateBulgariaProtocol';
// Mock Bybit client
class MockBybitClient {
    mockSymbols = [];
    mockOHLCVMap = new Map();
    setMockSymbols(symbols) {
        this.mockSymbols = symbols;
    }
    setMockOHLCV(symbol, ohlcv) {
        this.mockOHLCVMap.set(symbol, ohlcv);
    }
    async fetchTopSymbols(limit) {
...
class MockBinanceClient {
    mockSpotPrices = new Map();
    setMockSpotPrice(symbol, price) {
...
class MockOIWipeoutDetector {
    mockWipeouts = new Map();
    setMockWipeout(symbol, wipeout) {
        this.mockWipeouts.set(symbol, wipeout);
    }
    async detectWipeout(symbol) {
...
describe('UltimateBulgariaProtocol', () => {
    ...
    beforeEach(() => {
        ...
        protocol = new UltimateBulgariaProtocol(mockBybitClient, mockBinanceClient, mockOIDetector);
    });
    describe('scan', () => {
        it('should return null when no crashes detected', async () => {
            ...
            mockBybitClient.setMockOHLCV('BTCUSDT', [
                { timestamp: Date.now() - 300000, open: 50000, high: 50100, low: 49900, close: 50000, volume: 1000 },
                { timestamp: Date.now() - 240000, open: 50000, high: 50100, low: 49900, close: 50050, volume: 1000 },
                { timestamp: Date.now() - 180000, open: 50050, high: 50150, low: 49950, close: 50100, volume: 1000 },
                { timestamp: Date.now() - 120000, open: 50100, high: 50200, low: 50000, close: 50150, volume: 1000 },
                { timestamp: Date.now() - 60000, open: 50150, high: 50250, low: 50050, close: 50200, volume: 1000 },
            ]);
            // ETH is also flat
            mockBybitClient.setMockOHLCV('ETHUSDT', [
                { timestamp: Date.now() - 300000, open: 3000, high: 3010, low: 2990, close: 3000, volume: 1000 },
                { timestamp: Date.now() - 240000, open: 3000, high: 3010, low: 2990, close: 3005, volume: 1000 },
                { timestamp: Date.now() - 180000, open: 3005, high: 3015, low: 2995, close: 3010, volume: 1000 },
                { timestamp: Date.now() - 120000, open: 3010, high: 3020, low: 3000, close: 3015, volume: 1000 },
                { timestamp: Date.now() - 60000, open: 3015, high: 3025, low: 3005, close: 3020, volume: 1000 },
            ]);
        ...
        it('should return null when crash is market-wide (BTC also dropped)', async () => {
            ...
            mockBybitClient.setMockOHLCV('SOLUSDT', [
                { timestamp: Date.now() - 300000, open: 100, high: 100, low: 96, close: 100, volume: 1000 },
                { timestamp: Date.now() - 240000, open: 100, high: 100, low: 96, close: 98, volume: 1000 },
                { timestamp: Date.now() - 180000, open: 98, high: 98, low: 96, close: 97, volume: 1000 },
                { timestamp: Date.now() - 120000, open: 97, high: 97, low: 96, close: 96.5, volume: 1000 },
                { timestamp: Date.now() - 60000, open: 96.5, high: 96.5, low: 96, close: 96, volume: 1000 },
            ]);
            const result = await protocol.scan();
            expect(result).toBeNull();
        });
        it('should detect idiosyncratic crash when altcoin drops but BTC is flat', async () => {
            ...
            mockBybitClient.setMockOHLCV('BTCUSDT', [
                { timestamp: Date.now() - 300000, open: 50000, high: 50100, low: 49900, close: 50000, volume: 1000 },
                { timestamp: Date.now() - 240000, open: 50000, high: 50100, low: 49900, close: 49980, volume: 1000 },
                { timestamp: Date.now() - 180000, open: 49980, high: 50080, low: 49880, close: 49960, volume: 1000 },
                { timestamp: Date.now() - 120000, open: 49960, high: 50060, low: 49860, close: 49940, volume: 1000 },
                { timestamp: Date.now() - 60000, open: 49940, high: 50040, low: 49840, close: 49900, volume: 1000 },
            ]);
        ...
        it('should preserve all OI wipeout properties in result', async () => {
            ...
            // ETH crashed 5%
            mockBybitClient.setMockOHLCV('ETHUSDT', [
                { timestamp: Date.now() - 300000, open: 3000, high: 3000, low: 2850, close: 3000, volume: 1000 },
                { timestamp: Date.now() - 240000, open: 3000, high: 3000, low: 2850, close: 2950, volume: 1000 },
                { timestamp: Date.now() - 180000, open: 2950, high: 2950, low: 2850, close: 2900, volume: 1000 },
                { timestamp: Date.now() - 120000, open: 2900, high: 2900, low: 2850, close: 2870, volume: 1000 },
                { timestamp: Date.now() - 60000, open: 2870, high: 2870, low: 2850, close: 2850, volume: 1000 },
            ]);
        ...
        it('should handle multiple crashes and return first valid trap', async () => {
            ...
            mockBybitClient.setMockSymbols(['BTCUSDT', 'ETHUSDT', 'SOLUSDT', 'AVAXUSDT']);
            // BTC is flat
            mockBybitClient.setMockOHLCV('BTCUSDT', [
                { timestamp: Date.now() - 300000, open: 50000, high: 50100, low: 49900, close: 50000, volume: 1000 },
                { timestamp: Date.now() - 240000, open: 50000, high: 50100, low: 49900, close: 49980, volume: 1000 },
            ...
            mockBybitClient.setMockOHLCV('ETHUSDT', [
                { timestamp: Date.now() - 300000, open: 3000, high: 3000, low: 2880, close: 3000, volume: 1000 },
                { timestamp: Date.now() - 240000, open: 3000, high: 3000, low: 2880, close: 2950, volume: 1000 },
                { timestamp: Date.now() - 180000, open: 2950, high: 2950, low: 2880, close: 2920, volume: 1000 },
                { timestamp: Date.now() - 120000, open: 2920, high: 2920, low: 2880, close: 2900, volume: 1000 },
                { timestamp: Date.now() - 60000, open: 2900, high: 2900, low: 2880, close: 2880, volume: 1000 },
            ]);
            // SOL crashed 5% (HAS OI wipeout)
            mockBybitClient.setMockOHLCV('SOLUSDT', [
                { timestamp: Date.now() - 300000, open: 100, high: 100, low: 95, close: 100, volume: 1000 },
                { timestamp: Date.now() - 240000, open: 100, high: 100, low: 95, close: 98, volume: 1000 },
                { timestamp: Date.now() - 180000, open: 98, high: 98, low: 95, close: 96, volume: 1000 },
                { timestamp: Date.now() - 120000, open: 96, high: 96, low: 95, close: 95.5, volume: 1000 },
                { timestamp: Date.now() - 60000, open: 95.5, high: 95.5, low: 95, close: 95, volume: 1000 },
            ]);
            // AVAX crashed 3.5% (no OI wipeout)
            mockBybitClient.setMockOHLCV('AVAXUSDT', [
                { timestamp: Date.now() - 300000, open: 40, high: 40, low: 38.6, close: 40, volume: 1000 },
                { timestamp: Date.now() - 240000, open: 40, high: 40, low: 38.6, close: 39.2, volume: 1000 },
                { timestamp: Date.now() - 180000, open: 39.2, high: 39.2, low: 38.6, close: 38.9, volume: 1000 },
                { timestamp: Date.now() - 120000, open: 38.9, high: 38.9, low: 38.6, close: 38.7, volume: 1000 },
                { timestamp: Date.now() - 60000, open: 38.7, high: 38.7, low: 38.6, close: 38.6, volume: 1000 },
            ]);
...
//# sourceMappingURL=UltimateBulgariaProtocol.test.js.map