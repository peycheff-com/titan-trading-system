...
describe('FastPathClient Property Tests', () => {
    ...
    it('should preserve signal data through serialization round trip', () => {
        ...
        fc.record({
            ...
            source: fc.constantFrom('scavenger', 'hunter', 'sentinel'),
            ...
            const serialized = client.serializeMessage({
                signal,
                signature: client.sign(signal),
    ...
    it('should generate consistent HMAC signatures for identical signals', () => {
        fc.assert(fc.property(fc.record({
            ...
            signal_type: fc.constantFrom('PREPARE', 'CONFIRM', 'ABORT'),
            timestamp: fc.integer({ min: 1000000000000, max: 9999999999999 }),
            source: fc.constantFrom('scavenger', 'hunter', 'sentinel')
        }), (signal) => {
            const signature1 = client.sign(signal);
            const signature2 = client.sign(signal);
    ...
    it('should normalize signals consistently for signing', () => {
        fc.assert(fc.property(fc.record({
            ...
            const signature1 = client.sign(signal1);
            const signature2 = client.sign(signal2);
...
//# sourceMappingURL=FastPathClient.property.test.js.map