...
export class CVDCalculator {
  private tradeHistory: Map<string, TradeHistoryPoint[]> = new Map();
  private readonly MAX_HISTORY_SECONDS = 600; // Keep 10 minutes of history
   ...
   */
  getTradeHistory(symbol: string): TradeHistoryPoint[] {
