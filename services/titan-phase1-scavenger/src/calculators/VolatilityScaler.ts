...
export class VolatilityScaler {
  ...
  private readonly BASE_ATR_PERCENT = 0.5; // Baseline volatility (0.5% price movement)

  /**
   * Calculate volatility metrics for a symbol
   */
  public calculateMetrics(ohlcv: OHLCV[], period: number = this.DEFAULT_PERIOD): VolatilityMetrics {
    ...
    else if (clampedRatio > 2.5) regime = 'EXTREME';
