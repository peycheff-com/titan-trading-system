...
export declare class HotReloadConfigManager extends EventEmitter {
     ...
     */
    loadAndWatchServiceConfig(service: string): Promise<unknown>;
    /**
     ...
     */
    saveConfigWithEncryption(configType: 'brain' | 'phase' | 'service', configKey: string, config: Record<string, unknown>): Promise<void>;
    /**
