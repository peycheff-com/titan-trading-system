...
import { existsSync, statSync, unwatchFile, watchFile, writeFileSync } from 'fs';
import { join } from 'path';
import { getConfigEncryption } from './ConfigEncryption';
import { HierarchicalConfigLoader } from './HierarchicalConfigLoader';
...
export class HotReloadConfigManager extends EventEmitter {
    ...
    watchConfigFile(filePath, callback) {
        ...
        watchFile(filePath, { interval: this.options.watchInterval }, (curr, prev) => {
 ...
 */
export function createHotReloadConfigManager(options) {
