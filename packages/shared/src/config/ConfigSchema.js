...
export class ConfigValidator {
     ...
     */
    static validateBrainConfigOrThrow(data) {
        return this.validateOrThrow(BrainConfigSchema, data, 'brain');
    }
    /**
     * Validate phase configuration and throw if invalid
     */
    static validatePhaseConfigOrThrow(data) {
        return this.validateOrThrow(PhaseConfigSchema, data, 'phase');
    }
    /**
     * Validate infrastructure configuration and throw if invalid
     */
    static validateInfrastructureConfigOrThrow(data) {
     ...
     */
    static validateDeploymentConfigOrThrow(data) {
