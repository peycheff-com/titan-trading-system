...
import { BrainConfig as SchemaBrainConfig, Environment, PhaseConfig as SchemaPhaseConfig } from './config/ConfigSchema';
...
export declare class ConfigManager extends EventEmitter {
     ...
     */
    rollbackToVersion(configType: 'brain' | 'phase' | 'service', configKey: string, version: number): Promise<unknown>;
    /**
     * Compare configuration versions
     */
    compareConfigVersions(configType: 'brain' | 'phase' | 'service', configKey: string, fromVersion: number, toVersion: number): unknown;
    /**
