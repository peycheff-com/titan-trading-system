...
export const TITAN_SUBJECTS = {
    ...
    CMD: {
        EXECUTION: {
             ...
             */
            PLACE: (venue, account, symbol) => `titan.cmd.execution.place.v1.${venue}.${account}.${symbol}`,
            /**
    ...
    EVT: {
        ...
        EXECUTION: {
             ...
             */
            TRUTH: 'titan.evt.execution.truth.v1',
    ...
    DATA: {
        POWERLAW: {
             ...
             */
            METRICS: (venue, symbol) => `titan.data.powerlaw.metrics.v1.${venue}.${symbol}`,
        ...
        EXECUTION: {
             ...
             */
            CONSTRAINTS: (venue, account, symbol) => `titan.data.execution.constraints.v1.${venue}.${account}.${symbol}`,
            PREFIX: 'titan.data.execution.constraints.v1',
            ALL: 'titan.data.execution.constraints.v1.>',
        },
        MARKET: {
            TICKER: (venue, symbol) => `titan.data.market.ticker.v1.${venue}.${symbol}`,
        ...
        VENUES: {
             ...
             */
            STATUS: 'titan.data.venues.status.v1',
            /**
             * Normalized Market Trades (Hunter → Consumers)
             * Topic: titan.data.venues.trades.v1.{venue}.{symbol}
             */
            TRADES: (venue, symbol) => `titan.data.venues.trades.v1.${venue}.${symbol}`,
            TRADES_PREFIX: 'titan.data.venues.trades.v1',
            TRADES_ALL: 'titan.data.venues.trades.v1.>',
            /**
             * OrderBook Deltas & Snapshots (Hunter → Consumers)
             * Topic: titan.data.venues.orderbooks.v1.{venue}.{symbol}
             */
            ORDERBOOKS: (venue, symbol) => `titan.data.venues.orderbooks.v1.${venue}.${symbol}`,
            ORDERBOOKS_PREFIX: 'titan.data.venues.orderbooks.v1',
            ORDERBOOKS_ALL: 'titan.data.venues.orderbooks.v1.>',
        },
    },
    // ===========================================================================
    // 4. SYSTEM (titan.sys.*)
    ...
    SYS: {
         ...
         */
        HEARTBEAT: (service) => `titan.sys.heartbeat.v1.${service}`,
        /**
         * Generic RPC / Query namespace (Legacy titan.execution.* pattern)
         * Planning to migrate to titan.sys.rpc.* or similar.
         */
        RPC: {
            GET_POSITIONS: (venue) => `titan.execution.get_positions.${venue}`,
            GET_BALANCES: (venue) => `titan.execution.get_balances.${venue}`,
        },
    },
    // ===========================================================================
    // 5. OPS (titan.ops.*)
    // Control Plane Operations (Ops Daemon & Console)
    // ===========================================================================
    OPS: {
        COMMAND: 'titan.ops.command.v1',
        RECEIPT: 'titan.ops.receipt.v1',
        AUDIT: 'titan.console.audit.v1',
    },
    // ===========================================================================
    // 6. DLQ (titan.dlq.*)
    ...
    // ===========================================================================
    // 7. LEGACY / DEPRECATED (Quarantined)
 ...
 */
export function getDualPublishSubjects(type, ...args) {
    if (type === 'METRICS') {
...
//# sourceMappingURL=titan_subjects.js.map